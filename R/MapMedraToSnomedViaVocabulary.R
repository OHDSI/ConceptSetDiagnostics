...
mapMedraToSnomedViaVocabulary <-
  function(conceptIds,
    ...
    writeLines(
      "Looking for snomed that are descendants to MedDRA in concept ancestor table."
    )
    ...
    writeLines(
      "Looking for snomed that are related to MedDRA in concept relationship table."
    )
