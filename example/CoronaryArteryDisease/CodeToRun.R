keyWords1 <- 'Coronary Artery Disease'
keyWords2 <- 'Coronary Vessel Disease'
...
discoveredThruRecommender <- c(4130012)
# 4130012	Hashitoxicosis - transient	SNOMED	Condition	S	Not included - descendant	100	1	100	1
